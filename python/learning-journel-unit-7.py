...
According to my knowledge, the inverted dictionary is useful because I can still distinguished which words are from which group (uppercases, lowercases, mixedcases)
 """
